...
const editMode = (form)=>{
    const modifiedform = form.map((elemento)=>{
        return [
            elemento
        ];
    }).flat();
...
const findInArrayAndReplace = (array, identifier, identifierKey, replacer)=>{
        ...
        if ('children' in i.props) {
            return Object.assign(Object.assign({}, i), {
                props: Object.assign(Object.assign({}, i.props), {
                    children: [
                        ...findInArrayAndReplace(i.props.children, identifier, identifierKey, replacer)
                    ]
                })
            });
        }
...
const ItemSelectedContext = React.createContext(undefined);
const ItemSelectedContextProvider = (props)=>{
    const [item, selectItem] = React.useState(undefined);
    const value = {
        item,
        selectItem
    };
    return React.createElement(ItemSelectedContext.Provider, {
        value: value
    }, props.children);
};

const useItemSelected = ()=>{
    const ctx = React.useContext(ItemSelectedContext);
    if (!ctx) {
...
function Select$1(props) {
    ...
    return React.createElement("div", {
        ...
        className: "relative"
    }, React.createElement("input", Object.assign({}, register(name, Object.assign({}, props.props.validations)), {
        // {...props}
...
const FormContextProvider = ({ children, onDragEnd })=>{
    ...
    return React.createElement(FormContext.Provider, {
        ...
        onDragEnd: onDragEnd
    }, React.createElement(ItemSelectedContextProvider, null, children)));
};
...
const Tabs = (props)=>{
    ...
    return React.createElement("div", {
        ...
        "aria-label": "Tabs"
            ...
            className: `
                ${(formCtx === null || formCtx === void 0 ? void 0 : formCtx.activeTabs) === index ? 'font-msedium  text-black  border-pink-500' : ' text-gray-500  hover:text-gray-700 hover:border-gray-300'}
                shrink-0 border-b-2  px-1 pb-4 hover:cursor-pointer text-md  `
        }, tab.props.label)))), props.props.children.map((tab, index)=>{
        return React.createElement("div", {
            key: v4(),
            className: `${(formCtx === null || formCtx === void 0 ? void 0 : formCtx.activeTabs) === index ? 'block' : 'hidden'} p-4`
...
const Select = (props)=>{
    ...
    return React.createElement("div", {
        ...
        className: "block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2",
        htmlFor: name
    }, props.props.label), React.createElement("div", null, React.createElement("input", Object.assign({}, register(name, Object.assign({}, props.props.validations)), {
        type: "text",
        className: "appearance-none block w-full bg-white text-gray-700 border border-gray-300 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500",
        placeholder: "Buscar...",
        value: query,
...
const ItemProperties = (props)=>{
    ...
    return React.createElement("div", null, item ? React.createElement(PropertyEditor, {
        item: item,
...
exports.Input = Select$1;
exports.ItemProperties = ItemProperties;
exports.Tabs = Tabs;
exports.Title = Title;
exports.editMode = editMode;
exports.findInArrayAndReplace = findInArrayAndReplace;
