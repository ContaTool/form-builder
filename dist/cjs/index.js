...
const Input = (props)=>{
    ...
    var _a, _b, _c;
    const detailCtx = React.useContext(DetailedContext);
    ...
    }, props.props.label), React.createElement("input", Object.assign({}, register(name.current, Object.assign({}, props.props.validations)), {
...
const DetailedWrapper = (props)=>React.createElement(DetailedContextProvider, null, React.createElement(Detailed, Object.assign({}, props)));
