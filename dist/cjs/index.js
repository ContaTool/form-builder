...
const FormContextProvider = ({ children, onDragEnd })=>{
    const [item, setItem] = React.useState('Sin item ');
...
const Input = ()=>{
    ...
    const inputRef = React.useRef(v4());
    ...
    return React.createElement("div", {
        ...
        className: "relative"
    }, React.createElement("input", Object.assign({}, register(`${inputRef.current}-name`), {
...
const Tabs = (props)=>{
    ...
    return React.createElement("div", {
        ...
        }, tab.props.label)))), props.props.children.map((tab, index)=>React.createElement("div", {
...
const Reenderizer = ({ data, isEditing, parent, detailed })=>{
    ...
    return React.createElement(React.Fragment, null, data.map((item, index)=>{
        ...
        if (Component) {
            ...
            return React.createElement(React.Fragment, null, React.createElement(Component, Object.assign({}, commonProps), isEditing && item.props.children ? React.createElement(React.Fragment, null) : //   parent={{ id: item.id || '', type: item.type }}
            //   id={uuidv4()}
            //   key={uuidv4()}
            //   position={0}
            // />
...
const Form = (props)=>{
    ...
    return React.createElement(FormContextProvider, null, React.createElement(FormProvider, Object.assign({}, form), React.createElement("form", {
        onSubmit: form.handleSubmit((data)=>handleSubmit(data))
    }, React.createElement(Reenderizer, {
        data: props.form,
        isEditing: props.isEditing
    })), React.createElement("p", null, sum), React.createElement("button", {
