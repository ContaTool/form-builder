...
const DragDropContextProvider = ({ children, onDragEnd })=>{
    ...
    return React__default.createElement(DragDropContext.Provider, {
        value: values
    }, React__default.createElement(DragDropContext$1, {
...
const Tooltip = (props)=>{
    const [show, hasToShow] = useState(false);
    return React__default.createElement("div", {
        onMouseEnter: ()=>hasToShow(true),
        onMouseLeave: ()=>hasToShow(false),
        className: "relative"
    }, React__default.createElement(InfoIcon, null), React__default.createElement(ToolTipSquare, {
        text: props.text,
        show: show
    }));
};
...
const Title = (props)=>{
    ...
    }, React__default.createElement("p", null, props.props.label), props.props.guide_text ? React__default.createElement(Tooltip, {
        text: props.props.guide_text
    }) : null);
};
var Title$1 = React__default.memo(Title);

const TotalizerContext = createContext(undefined);
const TotalizerContextProvider = ({ children })=>{
    ...
    return React__default.createElement(TotalizerContext.Provider, {
        value: values
    }, children);
};
...
const Select = (props)=>{
    ...
    const [filteredOptions, setFilteredOptions] = useState((_b = props.props.option_values) === null || _b === void 0 ? void 0 : _b.filter((i)=>i.value != 'add'));
    ...
    return React__default.createElement("div", {
        ...
        text: props.props.guide_text
    }) : null)), React__default.createElement("div", null, React__default.createElement("input", Object.assign({}, register(name.current, Object.assign({}, props.props.validations)), {
        type: "text",
        className: "w-full rounded py-3 px-4\n          border-gray-500 border-2 border-solid\n          focus:ring-transparent focus:border-pink-500",
        placeholder: "Buscar...",
        value: query,
...
var SubTitle$1 = React__default.memo(SubTitle);

const DetailedWrapper = (props)=>React__default.createElement(TotalizerContextProvider, null, React__default.createElement(Detailed, Object.assign({}, props)));
const Detailed = (props)=>{
    ...
    return React__default.createElement("div", {
        onClick: handleClick,
        className: `${baseStyles} `
    }, React__default.createElement(React__default.Fragment, null, props.props.totalizar ? React__default.createElement("div", {
...
const CheckBox = (props)=>{
    ...
    }, React__default.createElement("input", Object.assign({}, register(name.current, Object.assign({}, props.props.validations)), {
        className: "mr-2 leading-tight",
        value: props.props.value,
        type: "checkbox"
    })), React__default.createElement("span", {
        className: "text-sm"
    }, props.props.label)), React__default.createElement("p", {
...
var Totalize$1 = React__default.memo(Totalize);

const TotalizeWrapper = (props)=>React__default.createElement(TotalizerContextProvider, null, React__default.createElement(Totalize$1, Object.assign({}, props)));
...
const RadioButtonContainer = (props)=>{
    ...
    }, props.props.children.map((checkbox, index)=>React__default.createElement("div", {
...
const PlaceHolder = (props)=>{
    ...
    return React__default.createElement(React__default.Fragment, null, props.isEditing ? React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
        onClick: handleClick,
        className: `${baseStyles} py-2 flex`
    }, React__default.createElement(PlaceholderEditor, Object.assign({}, props.props)))) : React__default.createElement(Reenderizer, {
        data: [
...
const SelectElements = (props)=>{
    ...
    return React__default.createElement(Select, Object.assign({}, interferedProps));
    ...
    return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", {
        ...
        droppableId: "droppable1"
            ...
            return React__default.createElement(PublicDraggable, {
                ...
                index: index
            }, (provided)=>React__default.createElement("div", Object.assign({}, provided.draggableProps, provided.dragHandleProps, {
                    ref: provided.innerRef,
...
export { Card$1 as Card, Form, FormContextProvider, ItemProperties, Select };
