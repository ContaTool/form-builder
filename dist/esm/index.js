...
function isplice(arr, start, deleteCount, ...addItem) {
    const result = [];
    if (start > 0) {
...
const DetailedContextProvider = ({ children })=>{
    ...
    return React__default.createElement(DetailedContext.Provider, {
        value: values
    }, children);
};
...
const DetailedWrapper = (props)=>React__default.createElement(DetailedContextProvider, null, React__default.createElement(Detailed, Object.assign({}, props)));
